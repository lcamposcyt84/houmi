      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-primary via-brand-primary to-[#0F2444]">
        ...
        <div className="container-custom relative">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-16 md:py-24 lg:py-32">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-slide-up animation-delay-200">
                <Link href="/products">
                  <Button variant="accent" size="lg" rightIcon={<ArrowRight className="w-5 h-5" />}>
                    Ver productos
                  </Button>
                </Link>
                <Link href="/products?category=bicicletas">
              ...
              {/* Quick stats */}
              <div className="mt-12 grid grid-cols-3 gap-6 animate-slide-up animation-delay-300">
                <div className="text-center lg:text-left">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 50L60 45.8C120 41.7 240 33.3 360 37.5C480 41.7 600 58.3 720 62.5C840 66.7 960 58.3 1080 50C1200 41.7 1320 33.3 1380 29.2L1440 25V100H1380C1320 100 1200 100 1080 100C960 100 840 100 720 100C600 100 480 100 360 100C240 100 120 100 60 100H0V50Z" fill="var(--brand-background)"/>
          </svg>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {categories.map((category, index) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-900/5 to-blue-900/10 p-6 md:p-8 hover:from-brand-primary hover:to-blue-900/90 transition-all duration-300 animate-fade-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="relative z-10">
                  <h3 className="font-semibold text-brand-text group-hover:text-white transition-colors text-lg">
                    {category.name}
                  </h3>
