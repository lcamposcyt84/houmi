    ...
    <div className="container-custom py-12 max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          {/* Orders */}
          <Link href="/account/orders" className="group flex-1 bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-blue-100 transition-all duration-300 relative overflow-hidden">
          ...
          {/* Wishlist */}
          <Link href="/account/wishlist" className="group flex-1 bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-red-100 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="md:col-span-2 bg-gray-50/50 rounded-[2rem] p-8 flex items-center gap-6 border border-gray-100">
            ...
            <div>
              ...
              <p className="text-sm text-brand-text-muted mt-1">
                Miembro activo desde el {new Date(customer.createdAt).toLocaleDateString("es-VE", { year: "numeric", month: "long", day: "numeric" })}
              </p>
            </div>
          </div>
